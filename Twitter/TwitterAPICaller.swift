...
class TwitterAPICaller: BDBOAuth1SessionManager {    
  ...
  //static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "oD4Dq5CMfJyBhl6Prx0FzUemO", consumerSecret: "OdQsxodQGnxpS54HT6S4ib28hN5ehfpSgf1voqSkYD0sjcR5dP")
